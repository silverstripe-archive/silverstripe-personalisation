...
class Tracker
{
     ...
     * @var array
     */
    public static $tracking_stores = array();
     ...
     * @var array
     */
    public static $store_instances = array();
    ...
    public static function clear_stores()
    {
     ...
     * @return void
     */
    public static function add_store($name, $class, $params = null)
    {
    ...
    public static function clear_finders()
    {
        self::$finders = array();
    }

    public static function add_finder($name, $finder)
    {
     ...
     * @return void
     */
    public static function init($addDefault = true)
    {
        self::clear_stores();
        self::clear_finders();
        if ($addDefault) {
     ...
     * @return void
     */
    public static function find_identities()
    {
        if (!self::$identity_cache) {
            ...
            foreach (self::$finders as $name => $finder) {
                ...
                if ($identity) {
                    $identities[$identity->getType()] = $identity->getIdentifier();
                }  // record all the identities we find, associated to the finder's type
            }
...
//
     ...
     * @return void
     */
    public static function track($properties, $storeName = null)
    {
    ...
    public static function query($pipeline, $storeName = null)
    {
        if (count(self::$tracking_stores) == 0) {
     ...
     * @return void
     */
    public static function get_store_inst($name)
    {
     ...
     * @return void
     */
    public static function get_properties($properties, $store = null, $notFoundNulled = false)
    {
     ...
     * 										cached environments.
     */
    public static function trackingJS($properties, $store = null, $includeIdentity = false)
    {
     ...
     * @return void
     */
    public static function get_metadata($namespaces)
    {
        $result = array();
        foreach (self::$tracking_stores as $name => $def) {
            $storeInst = self::get_store_inst($name);
