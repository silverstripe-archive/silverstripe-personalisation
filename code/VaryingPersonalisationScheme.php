...
class VaryingPersonalisationScheme extends PersonalisationScheme
{
    ...
    public static $is_abstract = true;
    ...
    public function personalise(Controller $controller = null)
    {
        ...
        if ($var instanceof PersonalisationVariation) {
            if ($var->ParentID != $this->ID) {
                $var = null;
            } // we got a variation but it is not for this scheme.
        }
        ...
        if ($var === null) {
            ...
            if (!$var) {
                return "";
            }   // bah, give up. if the user can't be bothered configuring it, they can't expect magic.
        }
    ...
    public function getSelectionProvider()
    {
